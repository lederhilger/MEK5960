...
For a more thorough derivation and explanation of the formalities of the theory and the background thereof, the reader is therefore refered to a dedicated text on the topic.
...
\begin{subequations}\label{eq:divergence_curl}
        \begin{equation}\tag{\theequation{a, b}}
                \int_{\Omega} \Div\uvec \,\dee V = \int_{\partial\Omega} \uvec\cdot \,\dee\mathbf{S}, \qquad \int_{\Omega} \Curl\uvec \cdot\dee\mathbf{S} = \int_{\partial\Omega} \uvec \cdot\dee\svec.
        \end{equation}
\end{subequations}
...
Finally, we shall derive the theory with which this thesis seeks to address its problems---namely the decomposition of fluid processes in solenoidal and vortical porcesses.
