...
Upon assuming conservative body forces, the \textsc{Navier}--\textsc{Stokes} equation then reduces to the \textsc{Euler} and incompressibility equations
...
It is apparent that the curl of the \textsc{Euler} equation \subeqref{\ref{eq:Euler_Incompressible}}[a] is zero when the fluid flow is irrotational, such that the vector field describing the fluid flow is harmonic.
