...
\noindent
This less natural approach to fluid mechanics has proven useful in the development of new methods in the finite element family, and the framework may indeed find itself useful for application to the boundary element family of solutions as well.
We shall use this framework as the basis for our discussion, as the theoretical framing of the methods to be presented gain credence therefrom.
We end the discussion on the nature of fluids as it pertains to this work with a rather illuminating theorem.%
\footnote{%
  \cite{falach2015reynolds} \textsc{Falach} \& \textsc{Segev} (2015)
}
